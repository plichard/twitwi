...
lang__Void StringBuffer_init_withCapa_impl(text__StringBuffer *this, lang__SizeT capacity)
{
	...
	this->data = (lang__Pointer) GC_MALLOC(((lang__SizeT) (capacity)));
	this->size = 0;
}
...
lang__Void StringBuffer_append_str_impl(text__StringBuffer *this, lang__String str)
{
	...
	memcpy(((lang__Pointer) (__OP_ADD_String_LLong(this->data, ((lang__LLong) this->size)))), ((lang__Pointer) (str)), ((lang__SizeT) (length)));
	this->size += length;
}
...
lang__Void StringBuffer_checkLength_impl(text__StringBuffer *this, lang__SizeT min)
{
	if (min >= this->capacity)
	{
		...
		lang__Pointer tmp = (lang__Pointer) GC_REALLOC(((lang__Pointer) (this->data)), ((lang__SizeT) (newCapa)));
		if (!tmp)
		{
			Exception_throw(Exception_new(StringBuffer_class(), __OP_ADD_String_LLong("Couldn\'t allocate enough memory for StringBuffer to grow to capacity ", ((lang__LLong) newCapa))));
		}
		this->data = tmp;
...
lang__Class *StringBuffer_class()
{
	...
	static text__StringBufferClass class = 
	{
		{
			{
				.size = sizeof(text__StringBuffer),
				.name = "StringBuffer",
			},
...
{
	text__StringBuffer *this = ((text__StringBuffer *) Class_alloc(StringBuffer_class()));
	StringBuffer_init_withCapa(this, ((lang__SizeT) (capacity)));
	return this;
}
