...
void Iterator_next(lang__Iterator *this, lang__Pointer returnarg69)
{
	((lang__IteratorClass *)((lang__Object *)this)->class)->next((lang__Iterator *) this, returnarg69);
}
